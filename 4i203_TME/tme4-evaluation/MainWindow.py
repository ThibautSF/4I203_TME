...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent = None ):
        ...
        self.stack.setCurrentWidget(self.introduction)
    ...
    def start_trial(self):
        ...
        # TODO
        ####################
        self.timeLastTrialBegin = time.time()
    ...
    def stop_trial(self):
        ...
        # TODO
        ####################
        #condition,cond,pos,tps,user_error,cond_user,pos_user
        #Simplifié:
        #condition,tps,user_error
        
        #Note : Il faut aussi sauvegarder le contenu de la ligne experiment.csv !
        
        oneTrialPos = self.pos_target
        oneTrialPosSelected = selected_target
        
        oneTrialCondition = self.condition
        oneTrialTimeDuration = self.timeLastTrialEnd - self.timeLastTrialBegin
        
        if oneTrialPosSelected == oneTrialPos:
            oneTrialIsError = False
        else:
            oneTrialIsError = True
        
        oneLine = oneTrialCondition + ',' + str(oneTrialTimeDuration) + ',' + str(oneTrialIsError) + '\n'
        print(oneLine)
        self.content += oneLine
    ...
    def keyReleaseEvent(self, e):
        if e.key() == Qt.Key_Space:
            if self.interTrial.isVisible():
                ...
                self.timeLastTrialEnd = time.time();
